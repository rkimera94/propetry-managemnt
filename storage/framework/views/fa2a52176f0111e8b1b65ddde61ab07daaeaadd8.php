        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="<?php echo e(route('list_category')); ?>" class="nav-link active">
...
<?php /**PATH /Users/mac/Desktop/rkimera/laravel_project2/complaint analysis/resources/views/layouts/portal.blade.php ENDPATH**/ ?>